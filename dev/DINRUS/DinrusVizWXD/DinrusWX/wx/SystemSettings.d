...
//! \cond EXTERN
extern (C) цел    wxSystemSettings_GetScreenType();
extern (C) проц   wxSystemSettings_SetScreenType(цел screen);

extern (C) ЦелУкз wxSystemSettings_GetColour(цел индекс);
extern (C) ЦелУкз wxSystemSettings_GetFont(цел индекс);
extern (C) цел    wxSystemSettings_GetMetric(цел индекс);
extern (C) бул   wxSystemSettings_HasFeature(цел индекс);
//! \endcond

//-----------------------------------------------------------------------------

export class СистемныеНастройки
{
    export static Цвет дайЦвет(ПСисЦвет индекс)
    {
    ...
    export static Шрифт дайШрифт(ПСисШрифт индекс)
    {
    ...
    export static цел дайМетрику(ПСисМетрика индекс)
    {
    ...
    export static бул естьФича(ПСисФича индекс)
    {
    ...
    {
        return cast(ПтипСисЭкрана)wxSystemSettings_GetScreenType();
    }
    static проц типЭкрана(ПтипСисЭкрана значение)
    {
        wxSystemSettings_SetScreenType(cast(цел)значение);
    }
