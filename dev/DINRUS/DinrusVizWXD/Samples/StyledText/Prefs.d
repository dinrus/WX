...
const цел mySTC_STYLE_Курсивный = 2;
...
const ткст CppWordlist1 =
    ...
    "export extern false плав for friend goto if inline цел long "
...
const ткст CppWordlist3 =
    ...
    "class код дата def defgroup deprecated dontinclude e em endcode "
    "endhtmlonly endif endlatexonly endlink endverbatim enum example "
    "exception f$ f[ f] file fn hideinitializer htmlinclude "
    "htmlonly if рисунок include ingroup internal invariant interface "
    "latexonly li строка ссылка mainpage имя namespace nosubgrouping note "
...
const ткст DWordlist1 =
	...
	"enum export extern false final finally плав for foreach "
	...
	"ubyte ucent бцел ulong union unittest бкрат version проц "
